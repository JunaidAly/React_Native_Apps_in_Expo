...
export default function App() {
  ...
  const [result, setResult] = useState('sdswdsdf');
  const colors = {
    dark: '#22252D',
    dark1: '#292B36',
    dark2: '#272B33',
  ...
  return (
    <View style={{
      height: '100%', width: '100%', paddingVertical: 0,
      ...
      <Text style={{
        fontSize: 40, color: getColor(colors.dark, colors.light),
        width: '100%', textAlign: 'right',
        paddingRight: 20, marginTop: 160,
        paddingBottom: 20
      }}>{result}</Text>
      <View style={{
        flexDirection: 'row',
